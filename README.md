...
│   ├── Console/                # Custom Artisan commands (Image conversion pipelines)
│   ├── Http/                   # Controllers, Social Auth & Middleware
│   ├── Livewire/               # Reactive Livewire components (CRUDs, cart, appointments)
│   ├── Models/                 # Eloquent ORM database models
│   └── Providers/              # Application service providers & global helpers
├── config/                     # Framework configuration files
├── database/                   # Migrations, seeders, and model factories
├── public/                     # Public web root (Compiled assets, optimized images, favicons)
├── resources/                  # Raw assets and view templates
│   ├── js/                     # Custom JavaScript modules & interactive scripts
│   ├── tailwind/               # Modular SCSS architecture & Tailwind styling
│   └── views/                  # Blade templates & Livewire layout views
├── routes/                     # Web and console route definitions
├── storage/                    # Application cache, file storage, and system logs
├── tests/                      # Testing suite (Laravel Dusk browser tests, Feature & Unit tests)
└── vite.config.mjs             # Vite module bundler configuration
