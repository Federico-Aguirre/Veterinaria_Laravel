...
@section('content')
    ...
    <section class="main seccion flex flex-col items-center">
        <section class="main__heroe flex flex-col justify-center items-center font-semibold">
            <x-picture src="imagenes/main__imagenPrincipal.jpg" alt="imagen principal" class="main__heroe__imagenPrincipal h-[200px] w-[300px] mt-[20px]" />
        ...
        <section class="main__servicios flex flex-col justify-center items-center text-green">
            ...
            <div class="main__servicios__contenedor flex flex-row">
                <x-picture src="imagenes/main__servicios__imagen1.jpg" alt="imagen de animal 1" class="main__servicios__contenedor__imagenIzquierda" />
        ...
        <section class="main__direccion flex flex-col justify-center items-center">
            ...
            <div class="main__direccion__ubicacion">
                <x-picture src="imagenes/iconos/ubicacion.png" alt="icono de ubicacion" />
                <div>Av. Independencia 1920</div>
            </div>
            <x-picture src="imagenes/mapa.jpg" alt="mapa" class="main__direccion__mapa mb-[20px]" />
            <div class="main__direccion__horario">
                <x-picture src="imagenes/iconos/calendario.png" alt="imagen calendario" />
                <div>Lunes a Sábado de 7:00AM a 22:00PM</div>
            </div>
            <div class="main__direccion__telefono">
                <x-picture src="imagenes/iconos/telefono.png" alt="imagen telefono" />
                <div>(011) 4400 2839</div>
            </div>
            <div class="main__direccion__whatsapp mb-0">
                <x-picture src="imagenes/iconos/whatsapp.png" alt="icono whatsapp" />
        ...
        <section class="main__mediosDePago flex flex-col justify-center items-center font-semibold">
            ...
            <div class="main__mediosDePago__tarjetasContenedor flex flex-row flex-wrap justify-center">
                <div>
                    <x-picture src="imagenes/tarjetas de credito/visa.svg" alt="tarjeta 1" />
                    <div>Visa</div>
                </div>
                <div>
                    <x-picture src="imagenes/tarjetas de credito/mastercard.svg" alt="tarjeta 2" />
                    <div>Master Card</div>
                </div>
                <div>
                    <x-picture src="imagenes/tarjetas de credito/mercado-pago.svg" alt="tarjeta 3" />
                    <div>Mercado Pago</div>
                </div>
                <div>
                    <x-picture src="imagenes/tarjetas de credito/american-express.svg" alt="tarjeta 4" />
